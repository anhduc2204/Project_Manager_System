...
namespace BTL_LTWeb.Migrations
{
    ...
    [Migration("20241030034826_InitSeed")]
            ...
            modelBuilder.Entity("BTL_LTWeb.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b18fb4d4-9541-4096-a728-496f769ec947"),
                            Name = "user",
                            NormalizedName = "USER",
                            Priority = 0
                        },
                        new
                        {
                            Id = new Guid("473c2a9e-320e-4194-8672-d9929f90588a"),
                            Name = "admin",
            ...
            modelBuilder.Entity("BTL_LTWeb.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a429ed06-491b-4d90-862a-fb1fb6f10cec"),
                            Address = "Khoa CNTT",
                            CreatedAt = new DateTime(2024, 10, 30, 3, 48, 25, 924, DateTimeKind.Utc).AddTicks(2897),
                            Email = "admin@fithou.com",
                            FullName = "Administrator",
                            PasswordHash = "AQAAAAEAACcQAAAAEAJFLXXlb97B1RA1Uj49grORsHKEBplbo5Bb/yw04vdkq/uGO9CoMjNodQQMygrjwg==",
            ...
            modelBuilder.Entity("BTL_LTWeb.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a429ed06-491b-4d90-862a-fb1fb6f10cec"),
                            RoleId = new Guid("473c2a9e-320e-4194-8672-d9929f90588a")
                        });
                });
